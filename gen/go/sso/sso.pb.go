...
type RegisterResponce struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserUd        int64                  `protobuf:"varint,1,opt,name=user_ud,json=userUd,proto3" json:"user_ud,omitempty"` // User id of register user.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterResponce) GetUserUd() int64 {
	if x != nil {
		return x.UserUd
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\auser_ud\x18\x01 \x01(\x03R\x06userUd\"W\n" +
